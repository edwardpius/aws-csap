...
# Attach policy - main account - epaws-management
aws iam attach-user-policy --user-name jack --policy-arn "arn:aws:iam::327450895851:policy/jack-ec2"
...
aws ec2 associate-iam-instance-profile --instance-id i-0b824033e6511b477 --iam-instance-profile Name=mytestinstanceprofile --profile jack
